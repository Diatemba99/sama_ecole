...
<nav class="navbar navbar-expand-lg navbar-light blue-grey lighten-5 mb-4">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="page/connect.php">Connexion</a>
      </li>
...
<div class="col-md-12 mb-4">
  ...
  <button type="button" class="btn aqua-gradient"><i class="fas fa-desktop pr-2"></i>Informatique</button>
  <button type="button" class="btn aqua-gradient"><i class="fas fa-tasks pr-2"></i>Management</button>
  <button type="button" class="btn aqua-gradient"><i class="fas fa-network-wired pr-2"></i>Telecom</button>
  <button type="button" class="btn aqua-gradient"><<i class="fas fa-bullhorn pr-2"></i>Marketing</button>
  <button type="button" class="btn aqua-gradient"><i class="fas fa-ship"></i>Transport et logistique</button>
</div>
...
<?php 
 ...
 $con = new PDO("mysql: host=localhost; dbname=sama_ecole", 'root','');
  ...
  if (isset($_POST["submit"]))
      {
        $str = $_POST['search'];
        $sth = $con-> prepare("SELECT * from `infos_ecole` where  nom = '$str'");
